...
# conda-forge-pinned in pixi.lock) AND lexd, which the `test` env composes from the
# managed `shipit-lexd` feature (ARF02-WS06, ADR-0066: lexd resolves from the Artifact
# channel through pixi.lock, no inline provisioning). So
