...
The roadmap is retired; per-capability PRDs under `docs/legacy-prd/` are the source of truth,
...
- Step 1 — gh-setup → `docs/legacy-prd/gh-setup.md`
- Step 2 — install + reconciliation → `docs/legacy-prd/install-reconciliation.md`
- Step 3 — lint / fmt checks → `docs/legacy-prd/lint-checks.md`
- Step 4 — PR flow (PRF01) → `docs/legacy-prd/prf01-pr-flow.md`
- OBS01 — logging foundation → `docs/legacy-prd/obs01-logging.md`
- OBS02 — review funnel → `docs/legacy-prd/obs02-review-funnel.md`
- OBS03 — async local-review execution → `docs/legacy-prd/obs03-async-review.md`
- OBS04 — readiness engine consumes the funnel → `docs/legacy-prd/obs04-readiness-engine.md`
- FLU01 — PRF01 review follow-ups → `docs/legacy-prd/flu01-prf01-followups.md`

## Active plan — adoption

The rollout plan is `docs/legacy-prd/adoption.md`: fleet adoption in three strictly-ordered
...
Dependency spine: OBS01 → … → OBS04 (shipped) + CLI02 (`docs/legacy-prd/cli-api-separation.md`) → ADP00 → ADP01 → ADP02.
...
- Step 5 — pixi test/build/run + changelog/release → `docs/legacy-prd/pixi-test-build-release.md` (execution slot: ADP02's build half)
- Step 6 — reusable workflows + release-core cutover → `docs/legacy-prd/workflows-cutover.md` (execution slot: ADP02; the one-real-release retirement gate stands)
