...
The coordinator is briefed as in the single-task cycle's information-gathering step [in](../../AGENTS.lex) — via the epic tracker issue, the PRD, or a chat with the maintainer. It does the general reading/research, CREATES the epic branch (the bare epic code — [see](./naming.lex)), and asks the maintainer for decisions/clarifications as needed.
