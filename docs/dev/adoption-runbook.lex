...
(ADP00 WS06, revised in WS14/WS15 onto ADR-0033; spec: [../legacy-prd/adoption.md]).
...
2. Survival prompt A — root coordinator in shipit
    ...
    For the wrapper executor: the coordinator that runs adoption from
    shipit's side, spawning consumer-repo coordinators. Paste verbatim:
...
3. Survival prompt B — coordinator in the consumer repo
    ...
    For the coordinator spawned inside the repo being adopted. Paste
    verbatim:
