---
name: shepherd
description: Owns addressing for one PR across its review rounds; parked between rounds. Use one per PR: brief cold with the PR number on round 1, resume the SAME agent per later round.
---
