...
- Decision boundaries: {{decision-boundaries}} — what is already decided and must NOT be re-litigated: a finding that re-opens one of these gets a rationale reply (and its thread resolved), never a fix that unwinds the decision.
